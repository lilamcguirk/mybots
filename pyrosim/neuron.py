...
class NEURON: 
    ...
    def Allow_Presynaptic_Neuron_To_Influence_Me(self, weight: float, pre_neuron_value: float):
        
        self.Add_To_Value(pre_neuron_value * weight)
